...
public class OlhoVivoAPITest {
    ...
    public void testSearchBusLines() throws Exception {
        ...
        Assert.assertEquals(correct, jsonParser.toJson(busLines));
    }
    ...
    public void testSearchBusStops() throws Exception {
        ...
        Assert.assertEquals(correct, jsonParser.toJson(busStops));
    }
    ...
    public void testGetAllBusCorridors() throws Exception {
        ...
        Assert.assertEquals(correct, jsonParser.toJson(busCorridors));
    }
    ...
    public void testSearchBusPositionsByLine() throws Exception {
        ...
        assertThat(jsonParser.toJson(busLinePositions), containsString(currentTime));
    }
    ...
    public void testGetForecastWithLineAndStop() throws Exception {
        ...
        String currentTime = new SimpleDateFormat("HH:mm").format(new Date());
        assertThat(jsonParser.toJson(forecast), containsString(currentTime));
    }

...
import com.intellij.busapi.BusAPIManager;
...
public class GtfsAPI {
    ...
    private static GtfsAPI ourInstance = null;

    public static GtfsAPI getInstance() {
        if (ourInstance == null) {
            ourInstance = new GtfsAPI();
            ourInstance.gtfsAcessor = ourInstance.gtfsHandler.getGtfsAcessor();
        }
        return ourInstance;
    }

    private GtfsAPI() {
        BusAPIManager busAPIManager = BusAPIManager.getInstance();
        gtfsHandler = new GtfsHandler(
                busAPIManager.getSptransLogin(),
                busAPIManager.getSptransPassword());
    }

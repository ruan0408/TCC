...
public class DataToAPIConverter {
    ...
    olhovivoBusArrayToBuses(com.smartsampa.olhovivoapi.Bus[] busArray) {
    ...
    private static <T extends Bus, K extends com.smartsampa.olhovivoapi.Bus>
    ...
    T buildFromAPIBus(com.smartsampa.olhovivoapi.Bus bus, Class<T> tClass) {
        T newBus = null;
        try {
